...
| 位置 | 路径 | 说明 |
|------|------|------|
| C 盘备份 1 | `C:\Users\17589\.openclaw\workspace\backups\knowledge-backup\` | 带时间戳，保留 7 天 |
| C 盘备份 2 | `C:\Users\17589\.openclaw\workspace\backups\knowledge-main\` | 带时间戳，保留 7 天 |
| D 盘备份 | `D:\AAAAAA\knowledge-backup\` 或 `D:\AAAAAA\ClaudeBackups\backup\` | 带时间戳，保留 7 天 |

#### 扎克的 3 个镜像文件位置
| 位置 | 路径 | 说明 |
|------|------|------|
| C 盘镜像 1 | `C:\Users\17589\.openclaw\workspace\memory-backup\mirror\` | 只保留最新 |
| C 盘镜像 2 | `C:\Users\17589\.openclaw\workspace\backups\mirror\` | 只保留最新 |
| D 盘镜像 | `D:\AAAAAA\ClaudeBackups\mirror\` | 只保留最新 |

**同步机制**: 每次更新主记忆文件时，同步到所有备份位置

**好处**: 6 份保护（3 备份 +3 镜像），数据更安全
