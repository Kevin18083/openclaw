 ...
 * - activate-self-improve.js（被测试模块）
 *
 * 常见问题：
 ...
 * - testHelp: 验证帮助信息完整
 * - testInit: 验证初始化正常
 * - testRecordSuccess: 验证成功记录
 * - testRecordError: 验证失败记录
 * - testReport: 验证报告生成
 * - testMetrics: 验证指标追踪
 * - 覆盖所有核心功能
 *
 ...
 * - WORKSPACE: 扎克系统工作区
 * - SCRIPT: 自我改进主脚本
 * - MEMORY_DIR: 记忆文件目录（存储改进记录）
 * - testHelp: 验证帮助文档完整性
 * - testInit: 验证系统初始化
 * - testRecordSuccess: 验证成功经验记录
 * - testRecordError: 验证失败教训记录
 * - testReport: 验证改进报告生成
 * - testMetrics: 验证性能指标追踪
 *
 * 性能特征：
 * - 测试执行时间：<5 秒
 * - 内存占用：<20MB
