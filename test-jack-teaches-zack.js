 ...
 * - 文件读取失败 → 检查文件权限
 * - Markdown 结构异常 → 检查被测试文件格式
 *
 * 设计思路：
 * 为什么设计 14 项测试？
 * - 测试 1 基础信息：验证文件基本属性
 * - 测试 2 Markdown 结构：验证标题层级
 * - 测试 3 代码块：验证代码块成对
 * - 测试 4 触发词：验证触发词列表
 * - 测试 5 互动章节：验证必需章节存在
 * - 测试 6 互动方式：验证互动模式
 ...
 *
 * 业务含义：
 * - FILE_PATH: 被测试的互动指南文件
 * - requiredSections: 必需的互动章节（7 大场景）
 * - interactionModes: 互动方式（问答/协作/教学）
 * - jack-teaches-zack.md: 杰克教扎克的互动指南
 * - 触发词：启动互动的关键词
 * - FAQ: 常见问题解答
 *
 * 性能特征：
